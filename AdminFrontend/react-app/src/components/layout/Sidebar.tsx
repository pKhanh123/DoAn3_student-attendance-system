...
const MENU_BY_ROLE: Record<string, { section: string; items: { label: string; icon: string; path: string }[] }[]> = {
  [ROLES.ADMIN]: [
    { section: 'TỔNG QUAN', items: [{ label: 'Dashboard', icon: 'fas fa-home', path: '/admin/dashboard' }] },
  ...
  [ROLES.LECTURER]: [
    { section: 'TỔNG QUAN', items: [{ label: 'Dashboard', icon: 'fas fa-home', path: '/lecturer/dashboard' }] },
    ...
    { section: 'PHÚC KHẢO', items: [{ label: 'Phúc khảo điểm', icon: 'fas fa-balance-scale', path: '/lecturer/appeals' }] },
    { section: 'BÁO CÁO', items: [{ label: 'Báo cáo', icon: 'fas fa-chart-bar', path: '/lecturer/reports' }] },
  ],

  [ROLES.ADVISOR]: [
    { section: 'TỔNG QUAN', items: [{ label: 'Dashboard', icon: 'fas fa-home', path: '/advisor/dashboard' }] },
    { section: 'QUẢN LÝ SINH VIÊN', items: [
  ...
  [ROLES.STUDENT]: [
    { section: 'TỔNG QUAN', items: [{ label: 'Dashboard', icon: 'fas fa-home', path: '/student/dashboard' }] },
    ...
    { section: 'KHIẾU NẠI', items: [{ label: 'Phúc khảo điểm', icon: 'fas fa-balance-scale', path: '/student/appeals' }] },
    { section: 'HỒ SƠ', items: [{ label: 'Hồ sơ cá nhân', icon: 'fas fa-user', path: '/student/profile' }] },
    { section: 'BÁO CÁO', items: [{ label: 'Báo cáo', icon: 'fas fa-chart-bar', path: '/student/reports' }] },
  ],
}
